        ...
        <Container className="main">
            <Row>
                <Col xs="12">                    
                    ...
                    <p>Functional Components are the primary tool in React ot build a small, modular piece of your page.</p>
                    <dl>
                        <dt>Can use state</dt>
                        <dd>With the "useState" hook, functional compnents can now both render a display to the plage and update the information to be shown.</dd>
                        <dt>No 'this' keyword</dt>
                        <dd>Old class components use 'this', functional components have no 'this' object</dd>
            ...
            <hr />
            <h1> Fat Arrow Function vs Regular Function Syntax </h1>             
            <Row>
                <Col md="6">
